...
PBMC_BLBR = genfromtxt('PBMC_BLBR_jan22.csv', delimiter=',',dtype=float, missing_values='NA')
BRAIN7_BLBR = genfromtxt('BRAIN7_BLBR_jan22.csv', delimiter=',',dtype=float, missing_values='NA')
BRAIN10_BLBR = genfromtxt('BRAIN10_BLBR_jan22.csv', delimiter=',',dtype=float, missing_values='NA')
BRAIN20_BLBR = genfromtxt('BRAIN20_BLBR_jan22.csv', delimiter=',',dtype=float, missing_values='NA')
...
for CpG in range(1,x):
    ...
    brain7=spearmanr(PBMC, BRAIN7)[1]
    brain10=spearmanr(PBMC, BRAIN10)[1]
    brain20=spearmanr(PBMC, BRAIN20)[1]
...
df.to_csv("correlation_jan22_PVAL.csv", sep='\t')
