...
load("Correlated_Negative_CpGs_atquantile0.275_and_corr_cutoffat_mixmodel.RData")
Correlated_inall_brain<-intersect(negCor_CpGs[[1]],negCor_CpGs[[2]])
Correlated_inall_brain<-intersect(Correlated_inall_brain, negCor_CpGs[[3]])

##total
ned<-unique(unlist(negCor_CpGs))
...
write.csv(x, file="Correlated_Negative_Genes_atquantile0.275_and_corr_cutoffat_mixmodel.csv")
...
write.csv(x, file="Correlated_Negative_AutosomalChrGenes_atquantile0.275_and_corr_cutoffat_mixmodel.csv")

Genes_correlated_CpGs_genes_sex<-format_geneTable(Genes_correlated_CpGs_sex)
x<-unique(Genes_correlated_CpGs_genes_sex$gene)
write.csv(x, file="Correlated_Negative_SexChrGenes_atquantile0.275_and_corr_cutoffat_mixmodel.csv")
...
write.csv(Genes_autosomal, file="Autosomal_genes_correlated_negative_BLBR.csv")



Probes<-Genes_correlated_CpGs[which(Genes_correlated_CpGs$gene=="CCNY"),]$Probe_ID
...
#plot top neg cor (function from BLBR_correlated_CpGs.Rmd)
```{r}
